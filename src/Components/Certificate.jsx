              ...
              <div className="w-full sm:w-11/12 md:w-1/2 lg:w-3/4 bg-white rounded-lg p-4">
                ...
                <div className=" flex w-auto justify-center px-20">
                  <p className="text-justify w-auto ">
                    ...
                    Using Python" Summer Internship conducted from 26th June
                    2023 - 22 July 2023 (Four) Weeks At The Department Of
                    Computer Science And Engineering / Computer Application.
                  </p>
                </div>
                <div className="signs flex justify-center pt-5 gap-24">
                  <div className="coordinater flex flex-col items-center mx-4 mt-16">
                    <img src={ayushSign} alt="" className="w-24 -mb-2 z-50" />
          ...
          <div className="left flex items-center h-screen justify-center animate__animated animate__fadeInLeft animate__slow	2s">
            <a class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <label
                ...
                className="block text-sm font-medium text-black pt-5">
                Certificate ID
              </label>
              <input
                type="text"
